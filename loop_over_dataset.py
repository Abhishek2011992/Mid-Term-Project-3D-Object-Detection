...
if data_filename == 'training_segment-1005081002024129653_5313_150_5333_150_with_camera_labels.tfrecord':
    data_file_idx = 1
elif data_filename == 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord':
    data_file_idx = 2
else:
    data_file_idx = 3
...
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results/'+ model_name + "_model" + "/results_sequence_" + str(data_file_idx) + "_" + model_name)
